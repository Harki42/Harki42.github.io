...
if (navToggle) {
    navToggle.addEventListener('click', () => {
        // Toggle the 'show-menu' class on each click
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Show the popup when the resume button is clicked
  ...
  resumeYes.addEventListener("click", () => {
      // Open the PDF file to let the user choose what to do
      window.open("assets/Harkirat-Rakhraj-Resume.pdf", "_blank");
  ...
  resumePopup.addEventListener("click", (event) => {
      if (!resumePopupContent.contains(event.target)) {
          resumePopup.style.display = "none";
      }
  });
});
